...
void radioRestoreState()
{
  ...
  else
  {
    ...
    */
    ...
    value = getProperty("ser_port");
    if (value)
      strcpy(ser_port, value);
    value = getProperty("serial_baud_rate");
    if (value)
      serial_baud_rate = atoi(value);
    value = getProperty("serial_enable");
    if (value)
...
void radioSaveState()
{
  ...
  if (!radio_is_remote)
  {
    ...
    */
    ...
    sprintf(value, "%s", ser_port);
    setProperty("ser_port", value);
